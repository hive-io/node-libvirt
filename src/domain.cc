...
#if LIBVIR_CHECK_VERSION(0,9,10)
  NODE_DEFINE_CONSTANT(exports, VIR_DOMAIN_SHUTDOWN_DEFAULT);
  NODE_DEFINE_CONSTANT(exports, VIR_DOMAIN_SHUTDOWN_ACPI_POWER_BTN);
  NODE_DEFINE_CONSTANT(exports, VIR_DOMAIN_SHUTDOWN_GUEST_AGENT);
  NODE_DEFINE_CONSTANT(exports, VIR_DOMAIN_SHUTDOWN_INITCTL);
  NODE_DEFINE_CONSTANT(exports, VIR_DOMAIN_SHUTDOWN_SIGNAL);
  NODE_DEFINE_CONSTANT(exports, VIR_DOMAIN_SHUTDOWN_PARAVIRT);
#endif
}
